...
\end{itemize}
  \item In the context of facing a bloated, unmaintainable library, how would
    you about it to achieve a positive change?
  \item Do you have experience with Lie Algebra, in the context of coordinate
    frames manipulation?
...
\begin{itemize}
  ...
  \item Can you tell me an example that showcases your problem solving
    capabilities?
  \item Which C++ standards would you enforce when mentoring new engineers?
\end{itemize}
